...
class TD1DevAccessPanelLootBuffInjector(HasTunableReference, metaclass=HashedTunedInstanceMetaclass,
...
class TD1DevAccessPanelLootBuffInjectorV2(HasTunableReference, metaclass=HashedTunedInstanceMetaclass,
                                        manager=services.get_instance_manager(Types.SNIPPET)):
    INSTANCE_TUNABLES = {
            ...
            tunable=TunableTuple(
                ...
                buff_reference=TunableList(
                    ...
                    tunable=TunableReference(
                        description='The buff for the loots to inject into.',
                        manager=services.get_instance_manager(Types.BUFF),
                        pack_safe=True,
                        allow_none=True
                    ),
